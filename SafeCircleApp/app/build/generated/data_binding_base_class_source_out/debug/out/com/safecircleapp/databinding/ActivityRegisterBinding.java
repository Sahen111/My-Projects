...
public final class ActivityRegisterBinding implements ViewBinding {
  ...
  private ActivityRegisterBinding(@NonNull RelativeLayout rootView, @NonNull Button btnNext,
      @NonNull EditText editTextTextEmailAddress2) {
  ...
  public static ActivityRegisterBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityRegisterBinding((RelativeLayout) rootView, btnNext,
