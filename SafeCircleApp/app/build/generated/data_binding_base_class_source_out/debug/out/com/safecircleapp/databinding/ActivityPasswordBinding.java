...
public final class ActivityPasswordBinding implements ViewBinding {
  ...
  private ActivityPasswordBinding(@NonNull RelativeLayout rootView, @NonNull Button btnNext,
  ...
  public static ActivityPasswordBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityPasswordBinding((RelativeLayout) rootView, btnNext, editTextTextPassword2);
    }
