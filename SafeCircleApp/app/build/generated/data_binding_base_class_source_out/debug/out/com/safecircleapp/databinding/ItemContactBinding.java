...
public final class ItemContactBinding implements ViewBinding {
  ...
  private ItemContactBinding(@NonNull LinearLayout rootView, @NonNull TextView contactName,
      @NonNull TextView contactNumber, @NonNull Switch toggleSwitch) {
  ...
  public static ItemContactBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      Switch toggleSwitch = ViewBindings.findChildViewById(rootView, id);
      if (toggleSwitch == null) {
        break missingId;
      }

      return new ItemContactBinding((LinearLayout) rootView, contactName, contactNumber,
          toggleSwitch);
    }
